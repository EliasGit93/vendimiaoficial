...
<div class="formulario">
	...
	<input type="text"  value="" id="nombre_cliente" class="clientes" style="width: 200PX;" name="Nombre" onkeypress="return valida_letras(event)"><br><
</div>
				<div>
...
<div >
	<label>RFC: </label></b>
	<input type="text" value="" id="rfc" class="clientes"  style="width: 200PX;"  name="RFC" onkeypress="return valida_rfc(evenmaxlength="16"><br><br>
</div>
</div>	
</div>
